...
import {CustomerEdit, customerEditSchema} from "@/shared/customer.validation";
import {redirect, useRouter} from "next/navigation";
import {editCustomerById} from "@/app/actions/customer.action";
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="bg-gray-50 dark:text-black dark:bg-black text-slate-800 max-w-sm items-center mx-auto rounded-xl shadow-2xl py-6 px-10 mt-10">
                ...
                <div className="flex flex-col gap-2">
                    <div className="flex flex-col">
                        <TextAreaWithLabel<CustomerEdit> fieldTitle="Address" nameInSchema="address" className="mb-2 dark:text-white"/>
                        <TextAreaWithLabel<CustomerEdit> fieldTitle="Notes" nameInSchema="notes" className="mb-2 dark:text-white"/>
                    </div>
                </div>
